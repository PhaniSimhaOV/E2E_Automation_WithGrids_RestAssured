...
public class DatabaseConnectionStepDefinition {
	...
	private String filePath = "src/test/resources/config/NewEnquiryWeb.xlsx"; // Output Excel file path
	...
	public void user_tries_to_save_the_fetched_data_into_the_file() {
		try {
			...
			List<String> queries = Arrays.asList("SELECT \r\n"
					...
					+ "    deb.scrap_through_oem AS exchangeScrapThroughHyundai,dl.sales_consultant as personInCharge, CASE \r\n"
					+ "        WHEN da.customer_type IS NOT NULL THEN da.customer_type \r\n"
					+ "        ELSE dc.customer_type \r\n"
					...
					+ "    AND dl.organization_id = 16 LIMIT 3;","SELECT\r\n"
							+ "    dl.phone,\r\n"
							...
							+ "    dad.street\r\n"
							+ "ORDER BY \r\n"
							+ "    db.created_date DESC\r\n"
							+ "LIMIT 3;\r\n"
							+ "","SELECT \r\n"
									+ "    dl.phone,\r\n"
									+ "    di.invoice_date,\r\n"
									+ "    (SELECT value \r\n"
									+ "     FROM dms_master_common \r\n"
									+ "     WHERE id = did.vehicle_usage_type_id) AS vehicleUsageType,\r\n"
									+ "    di.state_type,\r\n"
									...
									,"SELECT \r\n"
											...
											+ "    (SELECT value \r\n"
											+ "     FROM dms_master_common \r\n"
											+ "     WHERE id = del.next_followup_type_id) AS nextFollowupType,\r\n"
											+ "    CASE \r\n"
											+ "        WHEN dwt.task_status = 'RESCHEDULED' \r\n"
											+ "        THEN dwt.task_updated_time \r\n"
											+ "        ELSE '' \r\n"
											+ "    END AS nextFollowupTime,\r\n"
											+ "    CASE \r\n"
											+ "        WHEN x.status = 'CLOSED' \r\n"
											+ "        THEN 'YES' \r\n"
											+ "        ELSE 'NO' \r\n"
											+ "    END AS tdOffer,\r\n"
											+ "    x.model,\r\n"
